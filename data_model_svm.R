...
communities_data <- 
  read.table("/Users/katiechen/Downloads/Spring 2024/stat3106final/data.txt", 
             header=FALSE, sep=",", na.strings = "?", stringsAsFactors=TRUE)
...
names_file_path = '/Users/katiechen/Downloads/Spring 2024/stat3106final/communities.name'
...
SVMGrid_Lin <- expand.grid(C = c(0.01, 0.1, 0.3, 0.7, 0.9, 1.0))  # Linear SVM
