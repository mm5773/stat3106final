...
data_initial <- read.csv("C:/Users/suram/OneDrive/STAT UN3106 Applied Machine Learning/stat3106final/communities_data_final.txt", header = TRUE)
    ...
    tabPanel("Developing Final Model",
             ...
             sidebarLayout(
               sidebarPanel(
                 ...
                 conditionalPanel(
                   condition = "input.modelType == 'randomforest'"),
                 conditionalPanel(
                   condition = "input.modelType == 'xgboost'",
